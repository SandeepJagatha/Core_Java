...
public class C3_JoiningAndSynchronizeThreads {

	private int count = 0;

	public static void main(String[] args) {
		C3_JoiningAndSynchronizeThreads worker = new C3_JoiningAndSynchronizeThreads();
		worker.doWork();
	}
			...
			public void run() {
				for (int i = 0; i < 10; i++) {
					try {
						...
						Logger.getLogger(C3_JoiningAndSynchronizeThreads.class.getName()).log(Level.SEVERE, null, ex);
					}
				}
			}
		});
