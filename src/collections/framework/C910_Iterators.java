...
public class C910_Iterators {
	public static void main(String[] args) {
		 ...
		 * ListIterator using the .listIterator() method. ListIterator also has
		 * a previous() method, allowing you to "rewind" the iterator so that
		 * you can add items before the current item.
		 */
